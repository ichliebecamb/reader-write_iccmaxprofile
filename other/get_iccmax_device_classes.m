function device_classes = get_iccmax_device_classes(version)
...
device_classes = {  ...
        ...
        'abst', 'abstract'; ...
        'nmcl', 'named color';...
        'cenc', 'ColorEncodingSpace';...
        'mid ', 'MaterialIdentification';...
        'mlnk', 'MaterialLink';...
        'mvis', 'MaterialVisualization';...
        % only bg-srgb EncodingComplete
        'enc3', 'unkown';};
